...
For field shapes see [`WORLD_JSON_SCHEMA_v2.4.md`](../../WORLD_JSON_SCHEMA_v2.4.md#1-top-level-fields) §1.
...
Custom text *completely replaces* the default. The platform exposes template variables for use here: `<<skill_list>>`, `<<difficulty_list>>`, `<<skill_example>>`, `<<difficulty_example>>`, `<<skills_and_levels>>` — see [`WORLD_JSON_SCHEMA_v2.4.md`](../../WORLD_JSON_SCHEMA_v2.4.md#1-top-level-fields) §1.
