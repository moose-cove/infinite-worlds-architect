...
JSON key: `loreBookEntries` — array of keyword block objects. Each entry has `id`, `name`, `keywords` (string[]), `content`. For field shapes see [`WORLD_JSON_SCHEMA_v2.4.md`](../../WORLD_JSON_SCHEMA_v2.4.md#6-instruction-blocks) §6.
