...
For the full canonical list of v2.4 effect and condition types, see `WORLD_JSON_SCHEMA_v2.4.md` §5.
...
- **Schema shapes for every field above** — `WORLD_JSON_SCHEMA_v2.4.md`.
