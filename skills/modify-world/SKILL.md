---
name: modify-world
description: Edit an existing Infinite Worlds world through a guided approval workflow. Activated by phrases like "edit my world", "modify my world", "update my world", "I want to change my world", "add a character to my world", "add an NPC", "add a trigger", or any request to change specific fields in a world.
version: 0.1.0
---

# Modify World Workflow
...
Call `confirm_path(path)` with the user's provided path. Present the resolved path and confirm the file exists before proceeding.
