---
name: new-world
description: Create a new Infinite Worlds world from scratch using a guided field-by-field workflow. Activated by phrases like "create a new world", "start a new world", "make a world from scratch", "new Infinite Worlds adventure", or "build a world".
version: 0.1.0
---
...
Call `confirm_path` with the path the user wants to use.
...
**Player characters** (`possibleCharacters`):
