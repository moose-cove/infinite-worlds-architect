...
See [`AI_RUNTIME_MECHANICS.md`](../AI_RUNTIME_MECHANICS.md#5-author-style-guidelines) §5 for additional author-style discipline (consistency, model-tier proactivity, descriptive depth placement).
